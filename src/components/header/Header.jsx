...
const Header = () => {
  ...
  return (
    <header className="bg-[#43bb1b] text-white font-sans sticky top-0 z-50">
      <div className="w-full max-w-[400px] md:max-w-[680px] lg:max-w-[1024px] m-auto">
        ...
        <nav className="hidden md:block lg:block bg-[#43bb1b] border-t border-white">
          <ul className="flex flex-col md:flex-row lg:flex-row items-center space-x-10 px-5 py-3 text-lg">
            ...
            >
            <button
              className="inline-flex justify-center w-full px-4 py-2 text-lg text-white bg-[#43bb1b] rounded-md hover:bg-[#3da316] transition"
              onClick={() => {
            ...
            >
              ...
              <div
                className={`absolute left-0 z-10 mt-2 origin-top-left rounded-md bg-white shadow-lg transition-all duration-200 ease-out ${
                  isSubmenuOpen
              ...
              >
                <div className="py-1 text-black">
                  <NavLink
                    to="/products/giay-an-3-mau"
                    className="block px-4 py-2 text-sm hover:bg-gray-100"
                  >
                    Giấy ăn 3 màu
                  </NavLink>
                  <NavLink
                    to="/products/giay-an-da-sac"
                    className="block px-4 py-2 text-sm hover:bg-gray-100"
                  >
                    Giấy ăn đa sắc
                  </NavLink>
                  <NavLink
                    to="/products/giay-an-sac-ha"
                    className="block px-4 py-2 text-sm hover:bg-gray-100"
                  >
                    Giấy ăn sắc hạ
                  </NavLink>
                  <NavLink
                    to="/products/giay-an-gau-truc"
                    className="block px-4 py-2 text-sm hover:bg-gray-100"
                  >
                    Giấy ăn gấu trúc
                  </NavLink>
                  <NavLink
                    to="/products/giay-an-cao-cap"
                    className="block px-4 py-2 text-sm hover:bg-gray-100"
                  >
                    Giấy ăn cao cấp
                  </NavLink>
