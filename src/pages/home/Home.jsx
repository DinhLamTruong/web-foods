...
import { faTicket, faStar, faCreditCard,faRightLeft,faMessage} from '@fortawesome/free-solid-svg-icons';
...
const imageLogo = 'https://content.pancake.vn/1/s100x100/fwebp/ab/ce/95/60/b6b15051e37161b5734545c844fc4eccad211fb613ef46cefc8882d1-w:1200-h:1200-l:191878-t:image/png.png';
          ...
          <div className={`${styles.navItem} ${styles.super}`}>
            <div className={styles.content}>
              <div className={styles.innerContent}>
                ...
                <p className={styles.mainText}>KHUYẾN MÃI<br />CỰC SỐC</p>
              </div>
            </div>
          </div>
          <div className={`${styles.navItem} ${styles.promo}`}>
            <div className={styles.content}>
              <div className={styles.innerContent}>
                ...
                <p className={styles.mainText}>GIẢM GIÁ<br />VẬN CHUYỂN</p>
              </div>
            </div>
          </div>
          <div className={`${styles.navItem} ${styles.shipping}`}>
            <div className={styles.content}>
              <div className={styles.innerContent}>
                ...
                <h2 className={styles.mainText}>GIÁ <br />TỐT NHẤT</h2>
              </div>
            </div>
          </div>
        </div>
...
<div className={styles.ratingContainer}>
  <FontAwesomeIcon icon={faStar} className={styles.starIcon} /><strong> 4.9</strong> /5 (5.6k) | Đã bán<strong>  66.5K</strong>
</div>
            ...
            <div className="text-block">
              <h4 className="text-xs whiteSpace-nowrap">
                <span style={{ fontWeight: 400 }}>
                  <FontAwesomeIcon className={styles.iconservice} icon={faCreditCard} />
        ...
        >
          <div className="group-container">
            ...
            <div id="w-e2jgxe3u" className="com-text-block p-absolute">
              <div className="text-block">
                <h4 className="text-xs whiteSpace-nowrap">
                  <span style={{ fontWeight: 400 }}><FontAwesomeIcon className={styles.iconservice} icon={faRightLeft} />Đổi trả dễ dàng</span>
                </h4>
              </div>
            </div>
          </div>
        ...
        >
          <div className="group-container">
            ...
            <div id="w-3cb4nvoc" className="com-text-block p-absolute">
              <div className="text-block">
                <h4 className="text-xs whiteSpace-nowrap">
                  <span style={{ fontWeight: 400 }}> <FontAwesomeIcon className={styles.iconservice} icon={faMessage} /> Đội ngũ hỗ trợ 24/7</span>
                </h4>
              </div>
            </div>
          </div>
...
<div className={styles.paymentContainer}>
 ...
 <div className={styles.line}>
  <hr className={styles.divider} />
   ...
   <p className={`${styles.exchangeTitle}`}><strong>Chính sách đổi trả</strong></p>
<p className={`${styles.exchangeContent}`}>Đổi trả trong vòng <strong>3 ngày</strong>.</p>
<p className={`${styles.exchangeContent}`}>
  Cho phép kiểm tra hàng <strong>kiểm tra hàng</strong> trước khi thanh toán.
</p>

      <div className={styles.brandContainer}>
        <div className={styles.logoContainer}>
          <img src={imageLogo} alt="Bếp Xuyên Việt Logo" className={styles.logo} />
        </div>
      ...
      <div className="text-block">
        <h3 className="text-block-css full-width"> <strong>CAM KẾT VỀ CHẤT LƯỢNG</strong> </h3>
      </div>
